...
```bash
vue init Sherlock-777/vue-pc <project-name>
```

Example:

```bash
$ vue init Sherlock-777/vue-pc my-project
```
...
> i wrote a [vue-typescript-demo](https://github.com/Sherlock-777/vue-pc.git) project for practice, it recorded how I configured it and how to use vue.js with typescript
